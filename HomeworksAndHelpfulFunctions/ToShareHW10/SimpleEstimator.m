...
Va =  sqrt(max(0, 2 / density * press_dyn));% <======================STUDENT COMPLETE


%%%%%%%%%%%%%%%%%%%%
%%% position (gps)
%%%%%%%%%%%%%%%%%%%%
a_gps =  1; % <======================STUDENT SELECT
...
roll_hat =  atan2(-s_y, -s_z);% <======================STUDENT COMPLETE
pitch_hat =  asin(max(-1, min(1, s_x / g)));% <======================STUDENT COMPLETE
yaw_hat = chi_hat;%%%%%
...
aircraft_state_est =  [pn_hat; pe_hat; -hhat; roll_hat; pitch_hat; yaw_hat; Va; 0; 0; phat; qhat; rhat];% <======================STUDENT COMPLETE
     
wind_inertial_est = [0; 10; 0];
