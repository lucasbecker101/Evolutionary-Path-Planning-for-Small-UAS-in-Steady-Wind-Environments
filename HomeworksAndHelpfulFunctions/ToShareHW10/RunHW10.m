...
% Created: 4/2/2026
%  
% Homework 10 main script developed from Professor Frew's starter code
%
%
...
wind_inertial = [0;0;0];
wind_body = TransformFromInertialToBody(wind_inertial, aircraft_state0(4:6,1));
...
for i=1:n_ind
    ...
    control_objectives = OrbitGuidance(aircraft_state_con(:,i), gvf_speed, gvf_radius, gvf_center, gvf_flag, gvf_gains);
...
PlotSimulationWithCommands(time_iter,aircraft_state_est,control_array, wind_inertial_est, x_command, 'k--')
...
figure(12);
subplot(311)
plot(time_iter, estimator_error(1,:)); hold on;
